...
<div style="text-align: right"><font size = -1>For a PDF version of this document, please click [here](https://mfiorina.github.io/mief_sais_r_course/syllabus/mief_r_course_syllabus.pdf).</font></div>
...
# MIEF Skills Workshop: R

## Marc-Andrea Fiorina
Contact: mfiorin2@jh.edu
</center>
...
- Download R at this link: https://cran.r-project.org/
  ...
  - Mac users, click on 'Download R for MacOS' and then download the file called:
      - `R-4.5.1-arm64.pkg` if you have a more recent MacBook with an M1 chip.
      - `R-4.5.1.pkg` if you have an older MacBook with an Intel chip or run an older iOs.
  
- Download RStudio at this link: https://posit.co/download/rstudio-desktop/. Download the 'RStudio Desktop' version.

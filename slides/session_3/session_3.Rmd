...
penguins %>%
  mutate(
    across(
      matches("length_mm|depth_mm|body_mass"),
      ~ reshape_function(.x)
    )
  )
penguins %>%
...
**NOTE** — You should refer to documentation for the dataset, which can be found on [the course's landing page](https://mfiorina.github.io/mief_sais_r_course/), for details on the variables and their given values.
...
.panel[.panel-name[Session 2, Part 1 Challenge]
...
.panel[.panel-name[Session 2, Part 2 Challenge]
...
- The requisite data in the "data" folder. You should just need the data from the three sessions, which can be found on [the course's landing page](https://mfiorina.github.io/mief_sais_r_course/).

---
title: "R MIEF Skills Workshop — Session 2"
...
1. Successfully run the code in the `session_2_pt1.R` script
...
1. Successfully run the code in the `session_2_pt2.R` script
